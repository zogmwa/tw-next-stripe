  ...
  return (
    <div className="flex flex-col p-4" key={service.id}>
      ...
      <div className="flex items-end mt-2">
        ...
        <div className="flex content-end text-2xl">{showPricingData.filter(price => price.asset === service.id)[0].price.price}</div>
        <div className="pl-2 text-text-secondary">/{showPricingData.filter(price => price.asset === service.id)[0].price.per}</div>
      </div>
